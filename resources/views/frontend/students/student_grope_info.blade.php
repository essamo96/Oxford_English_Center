<div class="dash-card dash-card--flush ajax-content">
    ...
    <div class="detail-header">
        <div class="d-flex justify-content-between align-items-center mb-20">
            <h2 class="m-0" style="color:#fff;"><i class="fa fa-graduation-cap"></i> {{ $data->group->program->title }}</h2>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="dash-card" style="margin-bottom:18px;">
                    <h4 class="mb-20"><i class="fa fa-user"></i> Lecturer Info</h4>
                    ...
                    <a href="javascript:void(0);" data-id="{{ $data->group->id }}" data-user="{{ $data->group->name }}"
                       class="chat-toggle dash-btn dash-btn--primary dash-btn--block">
