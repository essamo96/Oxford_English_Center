            ...
            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                <div class="Home-details tab-content">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                                <div class="lecturers-contact-info">
                                                    ...
                                                    <img src="{{ asset($student_info->image) }}" class="img-responsive" alt="team" />
                                                    @else
                                                    <img src="{{ url('assets/oxford/img/students/avatar.png') }}" class="img-responsive" alt="team" />
                                                    @endif
                                                    {{-- <img src="img/team/13.jpg" class="img-responsive" alt="team"> --}}
                                                    @if ($student_info->name != '')
                                                    <h2>{{ $student_info->name }}<br>
                                                        <span href="#" style="" class="<?= $student_info->delaying != 0 ? 'enroll-btn22' : 'enroll-btn2' ?> m-2"><?= $student_info->delaying != 0 ? 'Delayed' : 'Active' ?></span>
                                                    ...
                                                    <ul class="lecturers-social2">
                                                        <li><a href="#AdminNotify" class="AdminNotify" data-toggle="tab" aria-expanded="false">
                                                                <i class="fa fa-envelope-o" aria-hidden="true"></i><strong id="count" style="">{{ $count }}</strong></a>
                                                        </li>
                                                        <li alt="incoming messages"><a href="#"><i id="dialog-btn" class="bi bi-chat " aria-hidden="true"></i></a>
                                                        </li>
                                                        <li><a href="#" data-toggle="tab" aria-expanded="false"><i class="bi bi-bell-fill" aria-hidden="true"></i></a>
                                                        </li>
                                                        <li><a href="{{ route('student.notifications') }}"><i class="bi bi-chat-heart" aria-hidden="true"></i></a>
                                                        </li>
                                                    </ul>
                                            ...
                                            <div class="col-xl-8 col-lg-8 col-md-6 col-sm-12">
                                                ...
                                                <div class="lecturers-contact-info" style="width: 500px;">
                                                    <ul class="lecturers-contact">
                                                        <a href="#StudentGroupsMarks" data-student_id="{{ Crypt::encrypt($student_info->id)}}" class="Markstudent" data-toggle="tab" aria-expanded="false">
                                                            <li><i class="bi bi-patch-check" aria-hidden="true"></i>Your Marks
                                                                {{-- {{ $grope_name }} --}}
                                                            </li>
                                                        </a>
                                                    </ul>
                                                ...
                                                <div class="lecturers-contact-info" style="width: 500px;">
                                                    <ul class="lecturers-contact">
                                                        <a href="#StudentGroupsProgress" data-student_id="{{ Crypt::encrypt($student_info->id)}}" class="StudentGroupsProgress" data-toggle="tab" aria-expanded="false">
                                                            <li><i class="bi bi-graph-up-arrow" aria-hidden="true"></i>progress</li>
                                                        </a>
                                                    </ul>
                                                </div>
                                            </div>
                    ...
                    <div class="tab-pane fade" id="Profile">
                        ...
                        <div class="form-horizontal" id="checkout-form">
                            <div class="personal-info">
                                <form class="form-horizontal" id="checkout-form" method="post" enctype="multipart/form-data" action="/student/editProfile">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Avatar</label>
                                        <div class="col-sm-9 public-profile-content">
                                            @if ($student_info->image != '')
                                            <img id="profileImg" src="{{ url($student_info->image) }}" alt="" style="margin-left: 52px;" />
                                            @else
                                            <img src="{{ url('assets/oxford/img/students/avatar.png') }}" style="box-shadow: rgba(50, 50, 93, 0.25) 0px 13px 27px -5px, rgba(0, 0, 0, 0.3) 0px 8px 16px -8px;" alt="" />
                                            @endif
                                            <div class="col-sm-4 public-profile-content">
                                                <div class="file-title" style="    color: #002147;margin-bottom: 20px;">new avatar JPEG
                                                    80x80 px</div>
                                                <div class="file-upload-area">
                                                    {{-- <span class="fa fa-2x fa-camera"></span> --}}
                                                    <input class="fa fa-2x fa-camera" type="file" name="fileToUpload" id="fileToUpload">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="name" value="<?= $student_info->name ?>" type="text" readonly="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Mobile No.</label>
                                        <div class="col-sm-9">
                                            <input class="form-control" id="mobile" value="<?= $student_info->mobile ?>" type="text" readonly="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
                                                <input type="text" class="form-control" readonly name="dob" value="<?= $student_info->dob ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" style="background: #fff" id="job" name="job" value="<?= $student_info->job ?>" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Email</label>
                                        <div class="col-sm-9">
                                            <input class="form-control" style="background: #fff" id="email" name="email" value="<?= $student_info->email ?>" type="text">
                                        </div>
                                    </div>
                    ...
                    <div class="tab-pane fade" id="Courses">
                        <h3 class="title-section title-bar-high mb-40">Coursess <button class="btn btn-success btn-sm" id="alert-code" value="<?= Crypt::encrypt($student_info->id) ?>"> Join Grope <i class="bi bi-grid-fill"></i></button>
                        </h3>
                        <div class="courses-page-area1">
                            <div class="container">
                                <div class="row">
                                    <div class="col-xl-9 col-lg-9 col-md-8 col-sm-12 order-md-2" style="margin-top: 49px;">
                                        <div class="tab-content">
                                            <div class="tab-pane tab-item animated fadeIn active" id="menu-1" role="tabpanel" aria-labelledby="menu-1-tab">
                                                <div class="row " style="display: flex; flex-wrap: wrap;">
                                                    @foreach ($student_groups as $group)
                                                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-12" style="display: flex; flex-direction: column">

                                                        <div class="courses-box1 ">
                                                            <div class="single-item-wrapper">
                                                                <div class="courses-img-wrapper hvr-bounce-to-bottom">
                                                                    <img class="img-responsive" @if ($group->group->image != null) src="{{ url($group->group->image) }}"
                                                                    @else
                                                                    src="{{ url('assets/oxford/img/logo.png') }}" @endif
                                                                    alt="courses" style=" width: 100%;">
                                                                    <a href="#Info" data-toggle="tab" aria-expanded="false" id="joinG" class="joinG" data-group_id="{{ Crypt::encrypt($group->group_id) }}" data-student_id="{{ Crypt::encrypt($group->student_id) }}">
                                                                ...
                                                                <div class="courses-content-wrapper">
                                                                    <a href="grope/detailes">
                                                                        <h3 class="item-title">
                                                                            {{ $group->group->program->title }}
                                                                        </h3>
                                                                    </a>
                                                                    <p class="item-content" style="color:#002147; font-size:15px; margin:3px;">
                                                                        {{ $group->group->name }}
                                                                        ||
                                                                        {{ $group->group->teacher->name }}
                                                                    </p>
                                                                    <p style="color:#002147; font-size:15px; margin:2px;">
                                                                        progress level ||@if ($group->progress == 30 || $group->progress ==null)
                                                                        Units 1 to 3
                                                                        @elseif ($group->progress == 60)
                                                                        Units 4 to 6
                                                                        @elseif ($group->progress == 90)Units 7 to 9
                                                                        @else Units 10
                                                                        @endif</p>
                                                                    <div class="progress" style="color: orange ;height: 16px;" role="progressbar" aria-valuenow="{{$group->progress}}" aria-valuemin="0" aria-valuemax="100">
                                                                        <div class="progress-bar bg-warning" style="width: {{$group->progress}}%; background-color: orange ;"><span style="padding-left: 120px; color :#002147;    font-size: 10px;">{{$group->progress != null ? $group->progress : 0 }}%</span></div>
                                                                    </div>
                                                                    <p class="item-content">
                                                                        {{ $group->group->program->short }}
                                                                    </p>
                                                                    <ul class="courses-info">
                                                                        ...
                                                                        <li style="padding-top: 20px; display: flex; justify-content: center; ">
                                                                            Chat Teacher <a style="padding-left: 26px;" href="javascript:void(0);" data-id="{{ $group->group->id }}" data-user="{{ $group->name }}" title="Open course Chat" class="btn-view chat-toggle bi bi-send-fill">
                                                                                Open Chat</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
...
<!-- Modal -->
<div class="modal fade" id="SubjectsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
        ...
        <div class="modal-content files">
            ...
            <div class="modal-body">
                <div class="container container1">
                    <div class="spn-load">
                        <img src="<?= url('assets/oxford/img/preloader.gif') ?>" alt="" class="loading" width="100">
                    </div>
