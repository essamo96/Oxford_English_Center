...
@section('content')
    ...
    <div style="background-color:#f8fafc;border:1px solid #e2e8f0;border-radius:12px;padding:24px 26px;margin:24px 0;">
        <p style="margin:0;font-size: 19.2px;line-height:1.7;color:#1e293b;white-space:pre-line;">{{ $replyBody }}</p>
    </div>

    @if(!empty($originalMessage))
        <p style="font-size: 16.2px;color:#94a3b8;margin-top:30px;border-top:1px solid #f1f5f9;padding-top:20px;">
