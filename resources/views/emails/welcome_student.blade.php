...
<div style="text-align: center;">
    <div style="margin-bottom: 30px;">
        <span style="display: inline-block; padding: 8px 16px; background-color: #f1f5f9; border-radius: 50px; font-size: 14px; font-weight: 600; color: #002147;">
            ✨ Success Registration | تم التسجيل بنجاح
        </span>
    </div>

    <h1 style="color: #002147; font-size: 28px; margin-bottom: 20px;">Welcome to Oxford, {{ $student->name }}!</h1>
    <h2 style="color: #002147; font-size: 22px; margin-bottom: 30px; font-weight: 600;">أهلاً بك في مركز أكسفورد الإنجليزي</h2>
    ...
    <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 25px; margin-bottom: 40px; text-align: left;">
        <h3 style="color: #002147; font-size: 18px; margin-top: 0; margin-bottom: 15px; border-bottom: 2px solid #e2e8f0; padding-bottom: 10px;">Registration Details | تفاصيل التسجيل</h3>
