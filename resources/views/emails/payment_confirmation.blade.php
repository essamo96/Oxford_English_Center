...
<div style="text-align: center;">
    <div style="margin-bottom: 30px;">
        <span style="display: inline-block; padding: 8px 16px; background-color: #ecfdf5; border-radius: 50px; font-size: 17.2px; font-weight: 600; color: #059669;">
            ✅ Payment Confirmed | تم تأكيد الدفع
        </span>
    </div>

    <h1 style="color: #002147; font-size: 31.2px; margin-bottom: 20px;">Payment Received!</h1>
    <h2 style="color: #002147; font-size: 25.2px; margin-bottom: 30px; font-weight: 600;">تم استلام رسوم اختبار المستوى بنجاح</h2>
    ...
    <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 25px; margin-bottom: 40px; text-align: left;">
        <h3 style="color: #002147; font-size: 21.2px; margin-top: 0; margin-bottom: 15px; border-bottom: 2px solid #e2e8f0; padding-bottom: 10px;">Payment Details | تفاصيل الدفع</h3>
