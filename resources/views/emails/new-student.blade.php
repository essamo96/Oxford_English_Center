...
@section('content')
    <h2 style="color: #002147; font-size: 23.2px; margin-bottom: 20px; text-align: right;">أهلاً بك {{ $studentName }}،</h2>
    
    <p style="font-size: 19.2px; line-height: 1.6; color: #444; margin-bottom: 25px; text-align: right;">
    ...
    <div style="background-color: #f8fafc; border-right: 4px solid #002147; padding: 25px; margin: 30px 0; border-radius: 4px;">
        <h3 style="color: #002147; margin-top: 0; font-size: 21.2px; text-align: right;">بيانات الدخول:</h3>
    ...
    <div style="text-align: center; margin: 35px 0;">
        <a href="{{ $loginUrl }}" style="background-color: #002147; color: #ffffff; padding: 14px 35px; text-decoration: none; border-radius: 8px; display: inline-block; font-weight: 600; font-size: 19.2px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
            أكمل تسجيل الدخول / Finish Login
        </a>
    </div>

    <p style="font-size: 17.2px; color: #718096; text-align: right; line-height: 1.6;">
