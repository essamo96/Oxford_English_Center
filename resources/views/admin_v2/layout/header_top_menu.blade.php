    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="{{ url('/admin') }}" class="d-lg-none">
                <img alt="Logo" src="{{ url('assets/images/kh.png') }}" class="h-30px" />
            </a>
        </div>
        <!--end::Mobile logo-->
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="d-flex align-items-center ms-3 ms-lg-5 ">
                    ...
                    <div class="btn btn-icon btn-topbar w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="click"
                        ...
                        <span class="svg-icon svg-icon-1 symbol symbol-50px">
                            @if ($holiday_count)
                                <span
                                    class="symbol-badge badge badge-circle bg-danger start-100">{{ $notify_count ? $notify_count : 0 }}</span>
                            @endif
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.3"
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                        ...
                        <div class="d-flex flex-column bgi-no-repeat rounded-top "
                            ...
                            <h3 class="text-white fw-semibold px-9 mt-10 mb-6">Notifications
                                <span class="fs-8 opacity-75 ps-3"><?= $notify_count ? $notify_count : '' ?>
                                    reports</span>
                            </h3>
                            <!--end::Title-->
                            <!--begin::Tabs-->
                ...
                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px"
                        ...
                        if (Auth::guard('admin')->user()->employee->attachments) {
                            $emp_attach = Auth::guard('admin')
                                ->user()
                                ->employee->attachments->where('attachmen_id', 1)
                                ->first();
                            if ($emp_attach) {
                                $img_path = $emp_attach->attachmen_bath;
                                if ($img_path && Storage::exists($img_path)) {
                                    $img = url('storage/' . $img_path);
                                } else {
                            ...
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">
                                        <?= Auth::guard('admin')->user()->employee->{'first_name_' . trans('app.lang')} . ' ' . Auth::guard('admin')->user()->employee->{'last_name_' . trans('app.lang')} ?>
                                        <span
