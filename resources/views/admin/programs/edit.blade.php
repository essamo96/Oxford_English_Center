        ...
        <form id="program_form" role="form" method="post" action="{{ route('programs.edit', Crypt::encrypt($info->id)) }}" class="form d-flex flex-column gap-7">
            ...
            <div class="row g-9 mb-8">
                <div class="col-md-6 fv-row">
                    ...
                    <input type="text" name="age" value="{{ $info->age }}" class="form-control form-control-solid" placeholder="مثال: 16 years old and older">
                </div>
                <div class="col-md-6 fv-row">
                    <label class="fs-6 fw-semibold mb-2">المستوى (Level)</label>
                    <input type="text" name="level" value="{{ $info->level }}" class="form-control form-control-solid" placeholder="مثال: Intermediate and above">
                </div>
            </div>
            <div class="row g-9 mb-8">
                <div class="col-md-6 fv-row">
                    <label class="fs-6 fw-semibold mb-2">الأسابيع (Weeks)</label>
                    <input type="text" name="weeks" value="{{ $info->weeks }}" class="form-control form-control-solid" placeholder="مثال: 5 weeks">
                </div>
                <div class="col-md-6 fv-row">
                    <label class="fs-6 fw-semibold mb-2">الساعات (Hours)</label>
                    <input type="text" name="hours" value="{{ $info->hours }}" class="form-control form-control-solid" placeholder="مثال: 30 hours">
                </div>
            </div>
            <div class="row g-9 mb-8">
                <div class="col-md-6 fv-row">
                    <label class="fs-6 fw-semibold mb-2">الامتحانات التجريبية (Mocks Exam)</label>
                    <input type="text" name="mock" value="{{ $info->mock }}" class="form-control form-control-solid" placeholder="مثال: 3 (hours 10)">
                </div>
                <div class="col-md-6 fv-row">
                    <label class="fs-6 fw-semibold mb-2">المدة (Duration)</label>
                    <input type="text" name="duration" value="{{ $info->duration }}" class="form-control form-control-solid" placeholder="مثال: 15 sessions (2 hours each)">
                </div>
            </div>
            <div class="row g-9 mb-8">
                <div class="col-md-6 fv-row">
                    <label class="fs-6 fw-semibold mb-2">حجم الفصل (Class Size)</label>
                    <input type="text" name="class_size" value="{{ $info->class_size }}" class="form-control form-control-solid" placeholder="مثال: Average 10, Maximum 15">
                </div>
                <div class="col-md-6 fv-row">
                    <label class="fs-6 fw-semibold mb-2">البدء (Start)</label>
                    <input type="text" name="start" value="{{ $info->start }}" class="form-control form-control-solid" placeholder="مثال: Monthly">
                </div>
            </div>
            <div class="row g-9 mb-8">
                <div class="col-md-6 fv-row">
                    <label class="fs-6 fw-semibold mb-2">الأيام (Days)</label>
                    <input type="text" name="days" value="{{ $info->days }}" class="form-control form-control-solid" placeholder="مثال: Saturday-Monday-Wednesday">
                </div>
                <div class="col-md-6 fv-row">
                    <label class="fs-6 fw-semibold mb-2">الوقت (Time)</label>
                    <input type="text" name="time" value="{{ $info->time }}" class="form-control form-control-solid" placeholder="مثال: 02:00 PM - 04:00 PM">
                </div>
            </div>
