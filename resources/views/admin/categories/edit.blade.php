    ...
    <div class="card-body py-4">
        ...
        <form role="form" method="post" action="" enctype="multipart/form-data" class="form d-flex flex-column gap-7">
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-9">
                    <input type="text" value="{{ $info->name }}" name="name" class="form-control form-control-solid" placeholder="الإسم">
                </div>
            </div>
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-9">
                    <input type="number" value="{{ $info->sort }}" name="sort" class="form-control form-control-solid" placeholder="الترتيب">
                </div>
            </div>
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-9">
                    <input type="text" value="{{ $info->tags }}" name="tags" class="form-control form-control-solid" data-role="tagsinput" placeholder="الكلمات الدلالية">
                </div>
            </div>
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-9">
                    <div class="input-group">
                        <input id="thumbnail" value="{{ $info->color }}" class="form-control form-control-solid" type="text" name="color" readonly>
                        <a id="lfm" data-input="thumbnail" data-preview="holder" class="btn btn-primary">
                            <i class="ki-duotone ki-picture fs-2"><span class="path1"></span><span class="path2"></span></i> حدد صورة
                        </a>
                    </div>
                    <img id="holder" src="{{ asset($info->color) }}" style="margin-top:15px;max-height:100px;">
                </div>
            </div>
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-9 d-flex align-items-center">
                    <div class="form-check form-switch form-check-custom form-check-solid">
                        <input class="form-check-input" type="checkbox" value="1" name="status" id="statusSwitch" {{ $info->status == 1 ? 'checked' : '' }}/>
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-9 d-flex align-items-center">
                    <div class="form-check form-switch form-check-custom form-check-solid">
                        <input class="form-check-input" type="checkbox" value="1" name="in_menu" id="inMenuSwitch" {{ $info->in_menu == 1 ? 'checked' : '' }}/>
