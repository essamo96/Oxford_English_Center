                                ...
                                <div class="scroll-y mh-325px my-5 px-8">
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="mb-0 me-2">
                                                <a href="#"
                                                    class="fs-6 text-gray-800 text-hover-info fw-bold">Project
                                                    Alice</a>
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="mb-0 me-2">
                                                <a href="#"
                                                    class="fs-6 text-gray-800 text-hover-info fw-bold">HR
                                                    Confidential</a>
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="mb-0 me-2">
                                                <a href="#"
                                                    class="fs-6 text-gray-800 text-hover-info fw-bold">Company
                                                    HR</a>
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="mb-0 me-2">
                                                <a href="#"
                                                    class="fs-6 text-gray-800 text-hover-info fw-bold">Banner
                                                    Assets</a>
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="mb-0 me-2">
                                                <a href="#"
                                                    class="fs-6 text-gray-800 text-hover-info fw-bold">Icon
                                                    Assets</a>
                                ...
                                <div class="scroll-y mh-325px my-5 px-8">
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--end::Code-->
                                            <!--begin::Title-->
                                            <a href="#" class="text-gray-800 text-hover-info fw-semibold">New
                                                order</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-info fw-semibold">Payment
                                                process</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-info fw-semibold">Search query</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--end::Code-->
                                            <!--begin::Title-->
                                            <a href="#" class="text-gray-800 text-hover-info fw-semibold">API
                                                connection</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-info fw-semibold">Database
                                                restore</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-info fw-semibold">System update</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-info fw-semibold">Server OS
                                                update</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-info fw-semibold">Refund process</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-info fw-semibold">Withdrawal
                                                process</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-info fw-semibold">Mail tasks</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                        <!--begin::Label-->
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <a href="#"
                                        class="fw-semibold text-muted text-hover-info fs-7">{{ Auth::user()->email }}</a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
