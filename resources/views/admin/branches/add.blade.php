...
<li class="breadcrumb-item"><span class="bullet bg-gray-400 w-5px h-2px"></span></li>
<li class="breadcrumb-item text-muted">إضافة فرع</li>
@stop
...
<div class="card shadow-sm">
    <div class="card-header border-0 pt-6">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold fs-3 mb-1">إضافة فرع جديد</span>
        </h3>
        ...
        <form role="form" method="post" action="" class="form d-flex flex-column gap-7">
            ...
            <div class="row g-9 mb-8">
                <div class="col-md-6 fv-row">
                    ...
                    <input type="text" value="{{ old('name_ar') }}" name="name_ar" class="form-control form-control-solid" placeholder="مثال: فرع المدينة المنورة">
                </div>
                <div class="col-md-6 fv-row">
                    <label class="fs-6 fw-semibold mb-2 required">اسم الفرع (إنجليزي)</label>
                    <input type="text" value="{{ old('name_en') }}" name="name_en" class="form-control form-control-solid" placeholder="e.g. Madinah Branch">
                </div>
            </div>
