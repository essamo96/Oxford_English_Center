...
@section('page-breadcrumb')
    ...
    <li class="breadcrumb-item"><span class="bullet bg-gray-400 w-5px h-2px"></span></li>
    <li class="breadcrumb-item text-muted">إضافة أسئلة التقييم</li>
@stop
    ...
    <div class="card shadow-sm">
        <div class="card-header border-0 pt-6">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">إضافة أسئلة تقييم جديدة</span>
            </h3>
                    ...
                    <div class="student mb-5 border border-dashed border-gray-300 p-5 rounded bg-light">
                        <div class="d-flex align-items-center gap-3">
                            <div class="flex-grow-1">
                                ...
                                <input type="text" class="form-control form-control-solid name_en" name="name_en[]" autocomplete="off" placeholder="نص التقييم...">
                            </div>
                            <div>
