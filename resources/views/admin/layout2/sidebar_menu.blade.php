...
<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo" style="justify-content: center;">
        ...
        <a href="{{ url('/admin') }}" style="background-color: #fff;padding: 2px;">
            <img alt="Logo" src="{{ url('/assets/oxford/img/logo.png') }}" class="h-35px app-sidebar-logo-default" />
            <img alt="Logo" src="{{ url('/assets/oxford/img/logo.png') }}" class="h-30px app-sidebar-logo-minimize" />
        </a>
        <span style="color: #fff;font-weight: bold;font-size: 1.1rem;margin-right: 10px;">Oxford English Centre</span>
        <!--end::Logo image-->
