...
<li class="breadcrumb-item"><span class="bullet bg-gray-400 w-5px h-2px"></span></li>
<li class="breadcrumb-item text-muted">تعديل سؤال</li>
@stop
...
<div class="card shadow-sm">
    <div class="card-header border-0 pt-6">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold fs-3 mb-1">تعديل السؤال</span>
        </h3>
    ...
    <div class="card-body py-4">
        ...
        <form role="form" method="post" action="{{ route('exam_questions.edit', ['id' => Crypt::encrypt($info->id)]) }}" enctype="multipart/form-data" class="form d-flex flex-column gap-7">
            {{ csrf_field() }}
