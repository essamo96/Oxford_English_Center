...
@section('page-breadcrumb')
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{ route('advertisements.edit',['id' => Crypt::encrypt($info->id)]) }}">تعديل إعلان</a>
        </li>
    </ul>
@stop
...
@section('page-content')
    <div class="portlet box {{ $form_class }}">
        <div class="portlet-title">
            <div class="caption">
                <i class="icon-grid"></i>تعديل إعلان </div>
        </div>
                ...
                <div class="form-body">
                    <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                        <img src="uploads/advertisements/{{ $info->image }}" alt=""/>
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select name="type" id="type" class="bs-select form-control">
                                    <option value="1" {{ $info->type == 1 ? 'selected' : '' }}>الإعلان الأول</option>
                                    <option value="2" {{ $info->type == 2 ? 'selected' : '' }}>الإعلان الثاني</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="expiry_date" name="expiry_date" class="form-control form-control-inline datepicker" data-date-format="yyyy-mm-dd" size="16" type="text" value="{{ $info->expiry_date }}" readonly placeholder="تاريخ الإنتهاء" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" value="{{ $info->url }}" name="url" id="url" class="form-control" placeholder="الرابط">
                            </div>
                        </div>
