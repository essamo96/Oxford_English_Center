{{-- Self-service student payment submissions — shared between the standalone
     "طلبات الدفع من الطلاب" page and the unified "الطلبات المالية العالقة" screen. --}}
<style>
...
$(function () {
    ...
    var table = $('#payRequestsTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ url("admin/financial/student-payments/list") }}',
            data: function(d) {
