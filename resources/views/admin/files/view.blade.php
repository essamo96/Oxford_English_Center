...
<li class="breadcrumb-item text-dark">المواد التعليمية</li>
@stop

@section('page-content')
@php $active_menu = 'files'; @endphp

<div class="card mb-7 shadow-sm">
    <div class="card-header border-0 pt-6">
        <div class="card-title">
            <span class="card-label fw-bold fs-3 mb-1">
                <i class="ki-duotone ki-magnifier fs-3 text-info me-2"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i> البحث في المواد
            </span>
        </div>
    </div>
...
<div class="card shadow-sm">
    <div class="card-header border-0 pt-6">
        <div class="card-title">
            <span class="card-label fw-bold fs-3 mb-1 text-info">
                <i class="ki-duotone ki-element-plus fs-3 text-info me-2"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i> إدارة المواد التعليمية
            </span>
        </div>
        <div class="card-toolbar gap-2">
            @can('admin.files.add')
                <a href="{{ route('files.add') }}" class="btn btn-primary btn-sm">
    ...
    <div class="card-body py-4">
        ...
        <div class="table-responsive">
            <table class="table align-middle table-row-dashed fs-6 gy-5 table-striped table-bordered text-center" id="files_table">
                <thead>
                    <tr class="text-start text-muted fw-bold fs-6 text-uppercase gs-0">
                        <th class="w-50px text-center"> # </th>
                        <th class="min-w-200px text-center"> الإسم </th>
...
<script>
    var table;
    var tableId = 'files_table';
    var customAjaxUrl = "{{ route('files.list') }}";
    var columns = [
...
@include('admin.layout.masterLayouts.datatableMaster', ['active_menu' => 'files'])
@stop
