...
<h1 class="page-title">اقسام التسوق
    <small>إدارة اقسام التسوق</small>
</h1>
@stop
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet box {{ $form_class }}">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-grid"></i>إدارة اقسام التسوق</div>
                @can('admin.partners.add')
                <div class="actions">
                    <a href="{{ route('shopping.add_category') }}" class="btn btn-default btn-sm">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var oTable = $('#categories_table').DataTable({
            ...
            "ajax": {
                url: "{{ route('shopping.list_category') }}",
                data: function (d) {
        ...
        $(document).on('click', ".status", function () {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('shopping.status_category') }}",
                data: {'id': id}
        ...
        $(document).on('click', ".delete", function () {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('shopping.delete_category') }}",
                data: {'id': id}
            }).success(function (data) {
                toastr[data.status](data.message);
                oTable.draw();
