...
<ul class="page-breadcrumb">
    ...
    <li>
        <a href="{{ route('shopping.view') }}">إدارة صنف تسوق</a>
        <i class="fa fa-angle-left"></i>
    </li>
    <li>
        <a href="{{ route('shopping.add') }}">إضافة صنف تسوق جديد</a>
    </li>
</ul>
@stop

@section('page-title')
<h1 class="page-title"> صنف تسوق
    <small>إضافة صنف تسوق</small>
</h1>
@stop
...
<div class="portlet box {{ $form_class }}">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-book-open"></i>إضافة صنف تسوق جديد </div>
    </div>
            ...
            <div class="form-body">
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="checkbox" value="1" name="status" class="make-switch" data-on-text="&nbsp;نعم&nbsp;" data-off-text="&nbsp;لا&nbsp;" {{ old('status') == 1 ? 'checked' : '' }}>
                        </div>
                    </div
                </div>
            </div>
