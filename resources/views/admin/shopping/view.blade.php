...
<h1 class="page-title">اصناف التسوق
    <small>إدارة اصناف التسوق</small>
</h1>
@stop
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet box {{ $form_class }}">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-grid"></i>إدارة اصناف التسوق</div>
                @can('admin.shopping.add')
                <div class="actions">
                    <a href="{{ route('shopping.add') }}" class="btn btn-default btn-sm">
