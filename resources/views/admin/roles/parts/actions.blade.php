<div class="d-flex justify-content-center gap-2">
    ...
    <a href="{{ route($active_menu.'.edit', Crypt::encrypt($id)) }}" class="btn btn-icon btn-light-success btn-sm" title="تعديل">
        <i class="bi bi-pencil-square fs-4"></i>
    </a>
    @endcan
    @can('admin.'.$active_menu.'.permissions')
    <a href="{{ route('roles.permissions',[ 'id' => Crypt::encrypt($id)]) }}" class="btn btn-icon btn-light-primary btn-sm" title="الصلاحيات">
