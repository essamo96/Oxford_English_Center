...
@section('title', 'إدارة اسئلة تقييم المعلمين')
...
<li class="breadcrumb-item"><span class="bullet bg-gray-400 w-5px h-2px"></span></li>
<li class="breadcrumb-item text-dark">اسئلة تقييم المعلمين</li>
@stop

@section('page-content')
@php $active_menu = 'questions'; @endphp
...
<div class="card shadow-sm">
    <div class="card-header border-0 pt-6">
        <div class="card-title">
            <span class="card-label fw-bold fs-3 mb-1 text-info">
                <i class="ki-duotone ki-medal-star fs-3 text-info me-2"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i> إدارة اسئلة تقييم المعلمين
            </span>
        </div>
        <div class="card-toolbar gap-2">
            @can('admin.questions.add')
                <a href="{{ route('questions.add') }}" class="btn btn-primary btn-sm">
    ...
    <div class="card-body py-4">
        ...
        <div class="table-responsive">
            <table class="table align-middle table-row-dashed fs-6 gy-5 table-striped table-bordered" id="questions_table">
                <thead>
...
@include('admin.layout.masterLayouts.datatableMaster', ['active_menu' => 'questions'])
@stop
