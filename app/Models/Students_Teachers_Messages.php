...
class Students_Teachers_Messages extends Authenticatable
{
    ...
    protected $table = 'students_teachers_messages';
    protected $fillable = [
        'title', 'content',
    ];
    protected $hidden = [
    ...
    //////////////////////////////////////////////
    function SaveMessages($title,  $content)
    {
        $this->title = $title;
    ...
    {
        DB::table('students_teachers_messages')
            ->where('id', $id)
            ->update(['note' => $note]);
    }
