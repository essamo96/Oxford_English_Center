...
class PartnersController extends AdminController {
    ...
    public function __construct() {
        parent::__construct();
        // parent::$data['active_menu'] = 'incentive_management';
        $this->path = 'partners';
    ...
    public function getIndex() {
        return view('admin.partners.view_v2', parent::$data);
    }
    ...
    public function getList(Request $request) {
        ...
        $datatable->editColumn('status', function ($row) {
            ...
            return view('admin.partners.parts.status_v2', $data)->render();
        });
        $path = $this->path;
        $datatable->addColumn('actions', function ($row) use ($path) {
            ...
            return view('admin.partners.parts.actions_v2', $data)->render();
        });
    ...
    public function postAdd(Request $request) {
        ...
        if ($validator->fails()) {
            ...
            if ($add) {
                ...
                return redirect(route('partners.view_v2'));
            } else {
    ...
    public function getEdit(Request $request, $id) {
        try {
            ...
            return redirect(route('news.view_v2'));
        }
        //////////////////////////////////////////////
        $partners = new Partners();
    ...
    public function postEdit(Request $request, $id) {
        try {
            ...
            $request->session()->flash('danger', self::NOT_FOUND);
            return redirect(route('pages.view_v2'));
        }
        /////////////////////////////
        $partners = new Partners();
        $info = $partners->getPartner($id);
