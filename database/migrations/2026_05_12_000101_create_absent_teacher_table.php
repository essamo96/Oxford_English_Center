...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('absent_teacher')) {
        Schema::create('absent_teacher', function (Blueprint $table) {
            $table->id();
    ...
    {
        // Schema::dropIfExists('absent_teacher'); // Safety: do not drop in synchronization
    }
};
