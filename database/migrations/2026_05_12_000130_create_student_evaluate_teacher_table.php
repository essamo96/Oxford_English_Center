...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('student_evaluate_teacher')) {
        Schema::create('student_evaluate_teacher', function (Blueprint $table) {
            $table->id();
    ...
    {
        // Schema::dropIfExists('student_evaluate_teacher'); // Safety: do not drop in synchronization
    }
};
